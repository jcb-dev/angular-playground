...
export enum ShoppingActionTypes {
    ...
    LOAD_SHOPPING_SUCESS = '[SHOPPING] Load Shopping Success',
    LOAD_SHOPPING_FAILURE = '[SHOPPPING] Load Shopping Failure',
...
export class LoadShoppingSuccessAction implements Action {
    readonly type = ShoppingActionTypes.LOAD_SHOPPING_SUCESS;
